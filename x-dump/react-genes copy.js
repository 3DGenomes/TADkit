	...
	componentWillReceiveProps: function(nextProps){
		// console.log(nextProps);
			if(nextProps.data){
				...
				if(nextProps.focusLength) focusLength = nextProps.focusLength;
				if(nextProps.sense) {
					sense = nextProps.sense;
				}
				this.renderChart(nextProps.data, nextProps.elem, assemblyLength, focusLength, sense)
			};
	},
	renderChart: function(dataset, elem, assemblyLength, focusLength, sense){
