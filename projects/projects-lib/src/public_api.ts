...
export * from './lib/components/projects-details/projects-details.component';
export * from './lib/components/projects-list/projects-list.component';
export * from './lib/projects-lib.module';
