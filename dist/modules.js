...
(function() {
	...
	/**
	 * @ngdoc service
	 * @name bioinformatics.service:ColorsEnsembl
	 * @description
	...
	angular
		.module('bioinformatics')
		.factory('ColorsEnsembl', ColorsEnsembl);

	function ColorsEnsembl(ONLINE, $log, $q, $http) {
		var colors = {};
		...
		return {
			...
			/**
			 * @ngdoc function
			 * @name bioinformatics.service:ColorsEnsembl#load
			 * @methodOf bioinformatics.service:ColorsEnsembl
			 * @kind function
			 *
			 * @description
			...
			/**
			 * @ngdoc function
			 * @name bioinformatics.service:ColorsEnsembl#get
			 * @methodOf bioinformatics.service:ColorsEnsembl
			 * @kind function
			 *
			 * @description
			 * Get colors ().
			 *
			 * @param {number} ref Reference to ColorsEnsembl object property.
			...
			/**
			 * @ngdoc function
			 * @name bioinformatics.service:ColorsEnsembl#colorsFromIni
			 * @methodOf bioinformatics.service:ColorsEnsembl
			 * @kind function
			 *
			 * @description
